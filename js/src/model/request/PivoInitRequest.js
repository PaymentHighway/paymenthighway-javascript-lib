...
(function (PivoInit) {
    class RequestBuilder {
        ...
        build() {
            return new PivoInitRequest(this.amount, this.currency, this.order, this.description, this.app_url, this.reference_number, this.webhook_success_url, this.webhook_cancel_url, this.webhook_failure_url, this.language, this.phone_number, this.splitting);
        }
    }
